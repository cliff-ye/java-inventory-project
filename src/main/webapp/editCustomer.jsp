<%-- 
    ...
    Created on : 23 Dec 2022, 13:28:49
    Author     : Clifford
--%>
      ...
      <ul class="navbar-nav me-auto mb-2 mb-lg-0">
        ...
        <li class="nav-item dropdown">
          ...
          <ul class="dropdown-menu">
            ...
            <li><a class="dropdown-item" href="viewCategory.jsp">View all categories</a></li>
          </ul>
        </li>
        <li class="nav-item dropdown">
...
<div class="card" style="width: 80rem; margin:100px auto; background-color:white; border:none;">
  <div class="card-body">
    ...
    <div class="row">
        ...
        try
        {
             ...
             while(rs.next())
             {
                ...
                <label>ID</label>
                <input type="text" class="form-control" name="id" value="<%=rs.getString("customerId")%>">
                </div>
                <div class="col-xl-6 col-lg-6 col-12 form-group">
    ...
    <div class="d-grid gap-2 d-md-block">
     <br>
    <button class="btn btn-primary btn-lg" name="bntAction" value="update" type="submit" style="background-color:rgb(255,204,0);border:none;width:100px">Update</button>
