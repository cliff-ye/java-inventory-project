<%-- 
    ...
    Created on : 23 Dec 2022, 07:04:04
    Author     : Clifford
--%>
      ...
      <% 
        try
        {
             ...
             while(rs.next())
             {
               ...
               <td><a class="btn btn-primary" href="editCustomer.jsp?id=<%=rs.getInt("customerId")%>" role="button">Edit</a></td>
               <td><a class="btn btn-primary" href="addCustomer?id=<%=rs.getString("customerId")%>" name="btnDel" value="deleteCustomer" role="button">Delete</a></td>
               </tr>
