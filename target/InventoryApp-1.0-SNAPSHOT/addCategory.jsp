<%-- 
    ...
    Created on : 29 Dec 2022, 12:59:12
    Author     : Clifford
--%>
      ...
      <ul class="navbar-nav me-auto mb-2 mb-lg-0">
        ...
        <li class="nav-item dropdown">
          ...
          <ul class="dropdown-menu">
            ...
            <li><a class="dropdown-item" href="viewProduct">View all products</a></li>
          </ul>
        </li>
        <li class="nav-item dropdown">
...
<!-- card -->
<div class="card" style="width:50rem; margin:100px auto; background-color:white; border:none;">
  <div class="card-body">
    ...
    <div class="d-grid gap-2 d-md-block">
     <br>
    <button class="btn btn-primary btn-lg" name="btnAction" value="addCat" type="submit" style="background-color:rgb(255,204,0);border:none;width:100px">Save</button>
