<%-- 
    ...
    Created on : 3 Jan 2023, 09:52:07
    Author     : Clifford
--%>
         ...
         try
         {
             ...
             String sql = "Select * from product where productId=?";
              ...
              while(rs.next())
              {
                  ...
                  <input type="text" name="prodId" class="form-control" value="<%=rs.getString("productId")%>" readonly>
                  </div>
                  <div class="col-xl-6 col-lg-6 col-12 form-group">
                        <label>Product Name</label>
                      <input type="text" name="prodName" class="form-control" value="<%=rs.getString("productName")%>">
                  </div>
                  <div class="col-xl-6 col-lg-6 col-12 form-group">
                  <br>
                  <label>Quantity</label>
                  <input type="text" name="qty" class="form-control" value="<%=rs.getString("qty")%>">
                  </div>
    
                   <div class="col-xl-6 col-lg-6 col-12 form-group">
                   <br>
                   <label>Price</label>
                   <input type="text" name="price" class="form-control" value="<%=rs.getString("price")%>">
                   </div>

                   <div class="col-xl-6 col-lg-6 col-12 form-group">
                   <br>
                   <label>Description</label>
                   <input type="text" name="description" class="form-control" value="<%=rs.getString("descriptions")%>">
                   </div>

                    <div class="col-xl-6 col-lg-6 col-12 form-group">
                   <br>
                   <label>Category</label>
                   <input type="text" name="cat" class="form-control" value="<%=rs.getString("category")%>"  readonly>
                   </div>
